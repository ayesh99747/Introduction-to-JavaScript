...
JavaScript is an Object Oriented Programming (OOP) language. 
    ...
    Object Properties
        Object properties can be any of the three primitive data types, or any of the abstract data types, such as another 
        object. 
        Object properties are usually variables that are used internally in the object's methods, but can also be globally 
    ...
    Object Methods
        ...
        There is a small difference between a function and a method – at a function is a standalone unit of statements 
...
*/
console.log('--------------------------');
console.log('OBJECT CONSTRUCTOR EXAMPLE');
console.log('--------------------------');
...
*/
console.log('------------------------');
console.log('THE WITH KEYWORD EXAMPLE');
console.log('------------------------');
...
JavaScript Native Objects
    ...
    These objects are accessible anywhere in your program and will work the same way in any browser running in any operating 
    system.
...
JavaScript Number Object
    ...
    In general, you do not need to worry about Number objects because the browser automatically converts number literals 
    to instances 
    of the number class.
...
JavaScript Date Object
    ...
    Most methods simply allow you to get and set the year, month, day, hour, minute, second, and millisecond fields of the 
    ...
    represent date and time till the year 27575.
